...
Deno.test('is.cellphone', () => {
  assertEquals(is.cellphone('11991111153'), true);
  assertEquals(is.cellphone('23992222264', { validateAreaCodes: true, locale: "pt-BR"}), false);
  assertEquals(is.cellphone('11991111153', { validateAreaCodes: true, locale: 'pt-BR' }), true);
})
...
Deno.test('should validate mobile phone number', () => {
  ...
  fixtures.forEach((fixture) => {
    ...
    const locale = Array.isArray(fixture.locale) ? fixture.locale?.[0] : fixture.locale ?? null

    fixture.valid.forEach((validNumber) => {
      assertEquals(is.cellphone(validNumber, { locale }), true);
    })

    fixture.invalid.forEach((invalidNumber) => {
      assertEquals(is.cellphone(invalidNumber, { locale }), false);
    })
